...
public class RightSemijoin extends JoinOperation {
    public RightSemijoin(Expression leftExpression, Expression rightExpression, ThetaCondition thetaCondition) {
